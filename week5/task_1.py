...
Original file is located at
    https://colab.research.google.com/drive/1JJmG-xfo4v7uw_-Fk_dsC9aoY6DGAsMw
"""
...
if __name__ == "__main__":
    ...
    detections_filename = "/content/mcv-m6-2020-team3/detections/detections{}_{}_{}.pkl".format(isFasterRCNN, seq, cam)
    ...
    for missing_chance in missing_chance_list:
        for lou_max_threshold in lou_max_threshold_list:
            ...
            for frameDistance, trackLen in zip(frameDistanceList, trackLenList):
                ...
                with open('/content/mcv-m6-2020-team3/detections/tracks_{}_{}_{}.pkl'.format(seq, cam, frameDistance), "wb") as f:
